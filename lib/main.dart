...
import 'package:act4anaya/firebase_options.dart';
...
class PaginaSesion extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        centerTitle: true,
        title: const Text('Negocio de lucha libre',
            style: TextStyle(color: Colors.white)),
        backgroundColor: const Color(0xffdb0606),
        elevation: 8,
      ),
      body: Padding(
      ...
      body: Center(
        child: Column(
          ...
          children: [
            Image(
                image: NetworkImage(
                    "https://raw.githubusercontent.com/AnayaMarinAngelAlejandro/img_iOS/main/WWE-Logo.png")),
